...
#ifndef QTBUTTONPROPERTYBROWSERPLUGIN_H
#define QTBUTTONPROPERTYBROWSERPLUGIN_H

#include <QDesignerCustomWidgetInterface>

class QtButtonPropertyBrowserPlugin : public QObject,
...
public:
    QtButtonPropertyBrowserPlugin(QObject *parent = 0);
