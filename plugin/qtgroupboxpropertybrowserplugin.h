...
#ifndef QTGROUPBOXPROPERTYBROWSERPLUGIN_H
#define QTGROUPBOXPROPERTYBROWSERPLUGIN_H

#include <QDesignerCustomWidgetInterface>

class QtGroupBoxPropertyBrowserPlugin : public QObject,
...
public:
    QtGroupBoxPropertyBrowserPlugin(QObject *parent = 0);
